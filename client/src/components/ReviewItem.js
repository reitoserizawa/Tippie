        ...
        if (!user.id || user_id === user.id) {
            ...
            <div class="helpful-thumb text-body-2 ml-3">
                <span class="fit-icon thumbs-icon">
                    <button type="button" onClick={() => setShowEdit(!showEdit)} class="btn btn-info btn-sm"><i class="fa-solid fa-pen"></i></button>
            ...
            <div class="helpful-thumb text-body-2 ml-3">
                <span class="fit-icon thumbs-icon">
                    <button onClick={deleteReview} type="button" class="btn btn-danger btn-sm"><i class="fa-solid fa-trash"></i></button>
                </span>
            </div>
            </>
        } else {
                ...
                <li>
                        <div class="right">
                            ...
                            <span class="gig-rating text-body-2">
                                <img src={image} class="profile-pict-img img-fluid" alt={name} style={{width: "32px", height: "32px", display: "block", borderRadius: "50%x"}} />
                            </span>
                                {name}
                                <span class="gig-rating text-body-2">
                            ...
                            <div class="review-description" style={{marginLeft:"50px", marginRight: "50px"}}>
                                <p>
                                    {review}
                                </p>
                            </div>
